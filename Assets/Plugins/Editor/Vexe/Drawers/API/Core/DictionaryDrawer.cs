...
{
    public class DictionaryDrawer<TD, TK, TV> : ObjectDrawer<TD> where TD : IDictionary<TK, TV>, new() where TK : new()
    {
...
//namespace Vexe.Editor.Drawers
//{
//    public class DictionaryDrawer<TK, TV> : ObjectDrawer<Dictionary<TK, TV>> where TK : new()
//    {
//        private List<ElementMember<TK>> keyElements;
//        private List<ElementMember<TV>> valueElements;
//        private KVPList<TK, TV> kvpList;
...
//                Log("Dictionary null " + dictionaryName);
//                #endif
//                memberValue = new Dictionary<TK, TV>();
//            }
