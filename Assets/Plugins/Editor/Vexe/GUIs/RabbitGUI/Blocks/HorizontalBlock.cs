...
namespace Vexe.Editor.GUIs
{
	...
	public class HorizontalBlock : GUIBlock
	{
		...
		//public void Laydfut(Rect start)
		//{
		//#if dbg
		//var watch = Stopwatch.StartNew();
		//#endif
		...
		//float unifiedWidth = (GetWidth(null, start) - totalDefinedWidth - totalSpace - margin.horizontal) /
		//(totalControls - nDefWidth);
		...
		//control.x = nextX + control.data.style.margin.left;
		//control.y = y;

		//if (!control.width.HasValue)
		//control.width = unifiedWidth;
